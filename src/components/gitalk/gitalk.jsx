...
class GitalkComponent extends Component {
    ...
    get loginLink() {
        ...
        const query = {
            client_id: clientID,
            redirect_uri: 'https://xn--4kq239b58hryh.xn--6qq986b3xl/en/comments',
            scope: 'public_repo'
        }
    ...
    noInit() {
        ...
        return (
            <div className="gt-no-init" key="no-init">
                ...
                {this.isAdmin ? <p>
                    <Button onClick={this.handleIssueCreate} isLoading={isIssueCreating}
                            text={this.i18n.t('init-issue')}/>
                </p> : null}
                {!user && <Button className="gt-btn-login" onClick={this.handleLogin}
        ...
        return (
          ...
          />
                    ...
                    <div className="gt-header-controls">
                        <a className="gt-header-controls-tip"
            ...
            __html: this.i18n.t('counts', {
                ...
                {isPopupVisible &&
                    <div className="gt-popup">
                        {user ? <Action className={`gt-action-sortasc${!isDesc ? ' is--active' : ''}`}
                                        onClick={this.handleSort('first')} text={this.i18n.t('sort-asc')}/> : null}
                        {user ? <Action className={`gt-action-sortdesc${isDesc ? ' is--active' : ''}`}
                                        onClick={this.handleSort('last')} text={this.i18n.t('sort-desc')}/> : null}
                        {user ?
                            <Action className="gt-action-logout" onClick={this.handleLogout}
                ...
                <div className="gt-user">
                    {user ?
                        <div className={isPopupVisible ? 'gt-user-inner is--poping' : 'gt-user-inner'}
